...
- **近30天趋势研究**：先打开小红书站内搜索页、公开笔记页或用户提供的站内链接，再筛选可核验的点赞 Top20；站内访问失败须经用户明确授权才能降级为公开网页调研，样本不足时如实说明
...
| 2. 趋势研究 | 仅给主题时先打开小红书站内页面，再研究近30天同类公开样本 | 记录站内访问结果；可核验点赞 Top20，或说明样本不足/降级原因 |
...
- 趋势研究必须先尝试打开小红书站内搜索页、公开笔记页或用户提供的站内链接；站内访问失败后，只有用户明确授权才可使用公开网页调研，并须记录降级原因和局限；
